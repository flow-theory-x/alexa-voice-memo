...
### 4. Alexa Skills Kit 準備完了
- ✅ 設定ガイド作成（`docs/alexa-skills-setup-guide.md`）
- ✅ Interaction Model JSON 作成
- ✅ Skill Manifest JSON 作成
- ✅ ローカルテストシミュレーター作成
...
### 1. Alexa Developer Console 設定（15分）
- アカウント作成/ログイン
- スキル作成
- JSONインポート
...
あとは起きてから Developer Console でポチポチするだけです！
