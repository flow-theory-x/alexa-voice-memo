...
Voice Memoスキルで使用できる音声コマンドの完全一覧です。
...
**応答例**:
- メモがある場合: "メモが3件あります。1番目、牛乳を買う。2番目、明日の会議。3番目、電話をかける。"
- メモがない場合: "メモはありません。"
...
**応答**: "現在3件のメモがあります。本当に削除してもよろしいですか？"
...
| "無効な招待コード" | コードが間違い/期限切れ | Web UIで新しいコードを生成 |
| "エラーが発生しました" | システムエラー | 少し待ってから再試行 |
| "理解できませんでした" | 未対応のコマンド | サポートされているコマンドを使用 |

### 🔧 トラブルシューティング
1. **Alexaが反応しない**: "アレクサ" ウェイクワードの後、少し待つ
...
- スキルを無効にして再度有効にする
- Alexaアプリでスキルの設定を確認する

---

**作成日**: 2025-07-14  
**バージョン**: 1.0  
**対応スキル**: ボイスメモ (Voice Memo)